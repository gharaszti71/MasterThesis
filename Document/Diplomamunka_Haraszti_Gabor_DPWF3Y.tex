...
\begin{document}
	...
	A feladathoz felhasznált alap, a ROS \cite{ROS}, melynek szolgáltatásai kívánjuk a TCP/IP hálózaton kerewsztül elérni, Internet-en keresztül távolról szolgáltatni. Alapvetõen arra tervezték, hogy robot kontrolleren fusson és helyi, egyedi protokollokon kommunikáljon a többi ROS példánnyal.\\
	...
	Alapvetõen a ROS egy middleware, mely bizonyos Linux disztribúciókra épül rá. Tartalmaz számos kódkönyvtárat, valamint több szolgáltatást is nyújt. Szerviz végpontokat nyújt távoli eljárások felé, úgynevezett RPC~\footnote{Remote Procedure Call} végpontokat lehet rajta definiálni. Üzenet továbbító szolgáltatása publisher/subscriber rendszerben képes adott formátumú üzenetek fogadására, továbbítására, valamint képes felvenni és visszajátszani a kapott vagy küldött üzeneteket. Az ilyen szolgáltatás végpontokat hívjuk a ROS terminológiában topic-oknak. Tartalmaz továbbá egy elosztott paraméter rendszert, globális katalógust, melyet, mint egy adatbázist a ROS Master-rõl lehet elérni.\\
	
	Az adott gépen futó ROS-ban Node-okat tudunk definiálni, melyek logikai összefoglalói a kiajánlott szolgáltatásoknak, "fizikailag" az operációs rendszer processzei. A ROS Master egy névtér és regisztrációs szolgáltatás a ROS Node-oknak.\\
